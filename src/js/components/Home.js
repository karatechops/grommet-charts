          ...
          <Carousel autoplay={false} infinite={false} name="container">
            <div>
              <Headline>Multi Area Chart</Headline>
                <Box className="carousel__item" direction="row" justify="between">
            ...
            <div>
              <Headline size="small">Turn-by-turn navigation and notifications provide your patrons with directions and up-to-date traffic and event information.</Headline>
            </div>
        </Carousel>
